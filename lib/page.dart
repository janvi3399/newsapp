...
class _MainPageState extends State<MainPage> {
          ...
          IconButton(
              onPressed: () {
                Navigator.of(context)
                    .push(MaterialPageRoute(builder: (context) => PDFscreen()));
              },
  ...
  Future<void> getNews({
    ...
    if (channel != null) {
      ...
      category = null;
      baseApi =
          'https://newsapi.org/v2/top-headlines?pageSize=10&page=$pageNum&sources=$channel&apiKey=2db2450da98f40068bd2aca51978f063';
    }
    if (searchKey != null) {
      country = null;
      category = null;
      baseApi =
          'https://newsapi.org/v2/top-headlines?pageSize=10&page=$pageNum&q=$searchKey&apiKey=2db2450da98f40068bd2aca51978f063';
    }
    //print(baseApi);
